...
# level_test = {"name": "test2"}
# person_test = {"name": "Сан Саныч", "phone": "555"}
# obj_test = {"name": "object10", "adress": "Октябрьская наб. 7"}
# change_test = {"name": "storno", "znak": True}
# qant_test = {"position_id": 1, "quantity": "1000.0"}
# new_pos = {"id": 1, "name": "12W/12-24V/DIN БЛОК ПИТАНИЯ FARADAY test", "quantity": "777.0"}
